...
const AdminSingleReportSettingsSection: FC<IProps> = ({
  ...
  const { initialAdminReportOptions, reorderedOptions } = useSelector(
    (state: any) => state.userSingleReport.userSingleReport
  );

  const [filteredOptions, setFilteredOptions] = useState<any>(
    reorderedOptions || initialAdminReportOptions
  );
  ...
  const handleResetOrder = () => {
    setFilteredOptions(initialAdminReportOptions);
  };
...
export default AdminSingleReportSettingsSection;
